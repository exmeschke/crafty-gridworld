...
function HTaskList(indices) {
    ...
    this.taskOptions[10] = new HTask(6, 2, 'Bake a loaf of bread. The oven will be on for two minutes. Make sure you collect the bread from the oven before it burns!', ['bread',1], '');
    this.taskOptions[11] = new HTask(6, 2, 'Bake a muffin. The oven will be on for two minutes. Make sure you collect the muffin from the oven before it burns!', ['muffin',1], '');
